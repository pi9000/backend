...
@section('panel')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h5 class="text-themecolor">Alias Accounts</h5>
                ...
                <div class="card-body">
                    <div class="card-title">
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-sm-2  text-sm-right">
                                <a href="/new_admin" class="btn btn-sm btn-success btn-rounded" title="Add Admin">New
                                    Admin</a>
                            </div>
                            @endif
                        </div>
                    </div>
                    <div id="alias_listing_table"></div>
                </div>
            </div>
        </div>
    </div>

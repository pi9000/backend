        ...
        <tbody style="text-align:center;color:black">
            @foreach ($data->data as $item)
                <tr>
                    ...
                    <td>
                        <span
                            id="suspend_{{ $item->extplayer }}_display">{{ $item->status_game == 1 ? 'On' : 'Off' }}</span>
                    ...
                    <td>
                        <span
                            id="verified_{{ $item->extplayer }}_display">{{ $item->verified == 1 ? 'Yes' : 'No' }}</span>
                    ...
                    <td>
                        ...
                        <input type="text" id="firstname_{{ $item->extplayer }}" name="player_firstname"
                            class="w-100" style="display:none" value="{{ $item->nama_lengkap }}">
                    </td>

...
<div class="pl-4 pr-4">
    <div class="row page-titles">
        <div class="col-md-12 align-self-center d-flex justify-content-between">
            <h5 class="text-themecolor">Member Summary</h5>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Report</a></li>
                    <li class="breadcrumb-item active" aria-current="/member_summary">Member Summary</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    var date_range = $('.date_range').val();
        ...
        $(document).ready(function() {
            ...
            function _get_daily_report_new(data) {
                $.get("/get_member_summary?" + data, function(d) {
                    unmuteButton()

...
<div class="table-responsive">
    <table class="table table-bordered table-hover tright medium agent_account_management_table">
        <thead>
            <tr>
                <th> # </th>
                <th> Frontend Template </th>
        ...
        <tbody style="text-align:center;color:black">
            @foreach ($admin as $item)
                <tr>
                    ...
                    <td> {{ getTemplates($item->brand_id)->name }} </td>
                    <td> {{ $item->username }} </td>
                    <td> {{ $item->fullname }}</td>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.agent_account_management_table').DataTable({
            dom: 'lfrtip',
            lengthMenu: [
                [50, 100, 150, 200, -1],
                [50, 100, 150, 200, "All"]

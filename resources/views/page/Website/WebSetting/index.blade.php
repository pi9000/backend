                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-borderless table-hover tright medium">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="width:250px">Snowfake / Custom Script: <span class="text-danger">*</span>
                                            </td>
                                            <td colspan="4">
                                                <div style="float:left">
                                                    <textarea rows="25" cols="140" style="width:500px" class="" id="costum_script" name="costum_script">{{ $data->web->costum_script }}</textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm table-bordered table-hover tright medium">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="width:150px">Token / Api Key</td>
                                                <td colspan="3">
                                                    <input style="width:500px" type="text" class=""
                                            ...
                                            <tr>
                                                <td style="width:150px">SecretKey</td>
                                                <td colspan="3">
                                                    <input style="width:500px" type="text" class=""

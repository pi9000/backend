                        ...
                        <fieldset>
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-borderless table-hover tright medium">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width:150px">Brand Name <button on type="button"
                                            ...
                                            <td colspan="3">
                                                <div style="float:left">
                                                    <input style="width:500px" type="text" class="" id="judul"
                                                        name="judul" value="{{ $data->web->judul }}" required>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <div style="float:left">
                                                    <input style="width:500px" type="file" class="" id="logo"
                                                        name="logo">
                                                    <img src="{{ $data->web->logo }}" class="img-thumbnail"
                                                        width="165px" />
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <div style="float:left">
                                                    <textarea name="title" id="" cols="30" rows="10" required>{{ $data->web->title }}</textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <div style="float:left">
                                                    <textarea name="deskripsi" id="" cols="30" rows="10" required>{{ $data->web->deskripsi }}</textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                <div class="livechat-container" style="float:left">
                                                    <textarea rows="4" cols="140" style="width:500px" class="" id="keyword" name="keyword">{{ $data->web->keyword }}</textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                <div style="float:left">
                                                    <textarea rows="4" cols="140" style="width:500px" class="" id="notif_bar" name="notif_bar">{{ $data->web->notif_bar }}</textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <div style="float:left">
                                                    <input style="width:500px" type="text" class=""
                                                        id="no_whatsapp" name="no_whatsapp"
                                                        value="{{ $data->contact->no_whatsapp }}">
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                <div style="float:left">
                                                    <textarea rows="20" cols="140" style="width:500px" class="" id="script" name="script">{{ $data->contact->script }}</textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                <div class="livechat-container" style="float:left">
                                                    <textarea rows="4" cols="140" style="width:500px" class="" id="telegram_chat_id"
                                        ...
                                        @if (auth()->user()->brand_id == 2)
                                            <tr class=" newTmpl" style="line-height: 2.5;">
                                                <td style="width:150px">Website Style (New) : <span
                                                ...
                                                <td colspan="3">
                                                    <div style="float:left">
                                                        <select id="websiteStyles2" name="web_styles" style="width:500px"
                                                            ...
                                                            <option value="style"
                                                                {{ $data->web->warna == 'style' ? 'selected' : '' }}>
                                                                One Night </option>
                                                            <option value="style2"
                                                                {{ $data->web->warna == 'style2' ? 'selected' : '' }}>
                                                                Green </option>
                                                            <option value="style3"
                                                                {{ $data->web->warna == 'style3' ? 'selected' : '' }}>
                                                                Dark Purple </option>
                                                            <option value="style4"
                                                                {{ $data->web->warna == 'style4' ? 'selected' : '' }}>
                                                                Stake Grey </option>
                                                            <option value="style5"
                                                                {{ $data->web->warna == 'style5' ? 'selected' : '' }}>
                                                                Black Gold </option>
                                                        </select>
                                                    </div>
                                                </td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                <div class="livechat-container" style="float:left">
                                                    <textarea rows="4" cols="140" style="width:500px" class="" id="tutorial_register"
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                <div class="livechat-container" style="float:left">
                                                    <textarea rows="4" cols="140" style="width:500px" class="" id="tutorial_deposit"
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                <div class="livechat-container" style="float:left">
                                                    <textarea rows="4" cols="140" style="width:500px" class="" id="tutorial_withdraw"
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                <div style="float:left">
                                                    <textarea rows="25" cols="140" style="width:500px" class="" id="costum_script"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea class="txtEditor" id="custom_menu_mobile_lang" name="home_footer" rows="15" cols="50">{!! $data->web->home_footer !!}</textarea>
                                            </td>
                                        </tr>
                                ...
                                <table class="table table-sm table-bordered table-hover tright medium">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <input style="width:500px" type="text" class=""
                                                    id="gateway_merchant" name="gateway_merchant"
                                                    value="{{ $data->web->gateway_merchant }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <input style="width:500px" type="text" class=""
                                                    id="gateway_apikey" name="gateway_apikey"
                                                    value="{{ $data->web->gateway_apikey }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <input style="width:500px" type="text" class=""
                                                    id="gateway_secretkey" name="gateway_secretkey"
                                                    value="{{ $data->web->gateway_secretkey }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <input style="width:500px" type="text" class=""
                                                    id="gateway_endpoint" name="gateway_endpoint"
                                                    value="{{ $data->web->gateway_endpoint }}">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-md-2">
                            <div class="form-group">
                                <button class="waves-effect waves-light btn btn-info  btn-block btn-rounded"
                                    type="submit" id="submit" form="update_webSettings">Save Changes </button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <form id="update_webSettings_pg{{ $item->id }}"
                            action="{{ url('/Website/WebSetting/UpdateApi') }}" method="post"
                            enctype="multipart/form-data">
                                    ...
                                    <table class="table table-sm table-bordered table-hover tright medium">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <input style="width:500px" type="text" class=""
                                                        id="apikey" name="apikey" value="{{ $item->apikey }}"
                                                        required>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <input style="width:500px" type="text" class=""
                                                        id="secretkey" name="secretkey" value="{{ $item->secretkey }}"
                                                        required>
                                                </td>
                                            </tr>
                                            <tr {{ $item->provider == 'NexusGGR' ? '' : 'style="display:none;"' }}>
                                                ...
                                                <td colspan="3">
                                                    <input style="width:500px" type="text" class=""
                                                        id="agentcode" name="agentcode" value="{{ $item->agentcode }}"
                                                        required>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <input style="width:500px" type="text" class=""
                                                        id="url" name="url" value="{{ $item->url }}"
                                                        required>
                                                </td>
                                            </tr>
                                        </tbody>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <button class="waves-effect waves-light btn btn-info  btn-block btn-rounded"
                                        ...
                                        form="update_webSettings_pg{{ $item->id }}">Save Changes </button>
                                </div>
                            </div>
                        </div>
                    </div>

$(function() {
    ...
    var e = function() {
        var e = window.innerWidth > 0 ? window.innerWidth : this.screen.width,
            i = 0;
        5170 > e ? ($("body").addClass("mini-sidebar"), $(".sidebartoggler i").addClass("ti-menu")) : $("body").removeClass("mini-sidebar"), 767 > e ? ($(".scroll-sidebar").perfectScrollbar(), $(".navbar-brand span").hide()) : ($(".scroll-sidebar").perfectScrollbar("destroy").removeClass("ps"), $(".navbar-brand span").show());
        var a = (window.innerHeight > 0 ? window.innerHeight : this.screen.height) - 1;
        a -= i, 1 > a && (a = 1), a > i && $(".page-wrapper").css("min-height", a + "px")
    };
